...
From writing feature descriptions for release notes to creating integration guides from scratch, my goal is to simplify complex technology and help users accomplish tasks with confidence. 
...
- [Taiga User Guide](../../wiki/Taiga-User_Guide): Describes how to use an agile project management tool for project managers. - **In Progress**
