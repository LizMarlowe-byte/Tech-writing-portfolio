...
From writing feature descriptions for release notes to creating API guides from scratch, my goal is to simplify complex technology and help users accomplish tasks with confidence. 
...
- [Optiflow-CloudSync CRM Integration Guide](../../wiki/Optiflow-CloudSync-CRM-Integration-Guide): Technical guide for support and services personnel that describes a system integration using data feeds, with diagrams and structured workflows.
